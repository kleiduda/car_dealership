...
function getUsers(): User[] {
    ...
    let users: User[] = JSON.parse(sessionStorage.getItem('users')!) || [
        {
            id: 1, username: '1234', email: 'kleitonsfreitas@gmail.com', password: '1234', firstName: 'Kleiton', lastName: 'Freitas',
            avatar: 'assets/images/users/user-2.jpg', location: 'São Paulo, BRA', title: 'Admin'
        }
    ];
    return users;
}
